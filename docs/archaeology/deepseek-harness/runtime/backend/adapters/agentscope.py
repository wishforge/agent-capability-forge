"""Phase 4-D AgentScope 2.0.2 backend adapter.

Dependency direction:

    runtime.py
        -> model_adapter (backend-neutral contract)
        -> backend.adapters.agentscope (this module, injected by caller)
        -> agentscope (public API only)

Nothing in the semantic runtime imports this module; the caller constructs it
and passes it to AgentRuntime/RuntimeCoordinator as a ModelAdapter.
"""
